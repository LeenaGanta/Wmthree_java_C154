...
<div class="navbar">Order Here</div>
<body>
<header><nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="nav justify-content-end" id="navbarNavAltMarkup">
        ...
        <a class="nav-item nav-link" href="./home">Home</a>
          <a class="nav-item nav-link" href="./addOns">Want AddOns </a>
...
<c:forEach items="${cupSizes}" var="cups">
	<input type="radio" checked="checked" name="cupSize" value="${cups}">${cups}
</c:forEach><br><br><br>

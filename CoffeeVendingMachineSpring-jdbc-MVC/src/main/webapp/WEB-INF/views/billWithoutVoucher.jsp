...
<div class="navbar">Bill Payment</div>
...
<h4>This is the payment required for your purchase ${user.name}</h4>
<br><br>
<c:forEach items="${billDetails}" var="bill1">
${bill1} <br>
</c:forEach>
<c:forEach items="${bill}" var="bill2">
TotalValue:${bill2.totalValue}<br>
Discount:${bill2.discount }<br>
Net Value:${bill2.netValue }<br>
GST:${bill2.gst }<br>
Service Tax:${bill2.serviceTax }<br>
Total Bill:${bill2.totalBill }<br>
</c:forEach>
</div>
</div>
</div>
